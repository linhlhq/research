# IrfanView 4.53 - Probably Exploitable - Data from Faulting Address controls Code Flow starting at JPEG_LS+0x0000000000003155 (Hash=0x835c8562.0xf92d1621)

## The bug

```
CommandLine: C:\Users\linhlhq\Desktop\linhlhq\IrfanView\i_view32.exe C:\Users\linhlhq\Desktop\linhlhq\IrfanView\crash\salve\id_000007_00.jls
...
ModLoad: 00bc0000 00c7b000   C:\WINDOWS\SysWOW64\RPCRT4.dll
...
(1f94.2730): Break instruction exception - code 80000003 (first chance)
eax=00000000 ebx=00204000 ecx=55cd0000 edx=00000000 esi=008820d0 edi=7764688c
...
(1f94.2730): Access violation - code c0000005 (first chance)
First chance exceptions are reported before any exception handling.
This exception may be expected and handled.
eax=0019d820 ebx=00000001 ecx=00000080 edx=00000012 esi=00000000 edi=0019d8a0
eip=6cb83155 esp=0019d800 ebp=0019d83c iopl=0         nv up ei pl nz na po nc
...
Recommended Bug Title: Probably Exploitable - Data from Faulting Address controls Code Flow starting at JPEG_LS+0x0000000000003155 (Hash=0x835c8562.0xf92d1621)
